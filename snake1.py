# watched until 55:38 https://watch.nettohikari.com/watch?v=XGf2GcyHPhc&autoplay=1&continue=1&dark_mode=true&hl=en-US&listen=0&local=1&loop=0&nojs=0&player_style=youtube&quality=dash&thin_mode=false
import math
import pygame
import random
